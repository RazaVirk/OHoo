...
window.handleMultiTouch = handleMultiTouch;
...
window.openWatchEarn = openWatchEarn;
window.closeWatchEarn = closeWatchEarn;
window.startAd = startAd;
window.skipAutoAd = skipAutoAd;
...
window.buyTapEffect = buyTapEffect;
window.setTapEffect = setTapEffect;
